...
export const LibraryPage = () => {
  ...
  return (
    <main className="flex-1 flex flex-col max-w-[1100px] mx-auto w-full px-4 md:px-10 py-12">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          {filters.map((f) => (
            <button
              ...
              className={`px-5 py-2 rounded-full text-xs font-black transition-all duration-200 flex items-center gap-2 border active:scale-95 ${
                filter === f.name
      ...
      <div className="flex flex-col border border-slate-200 rounded-2xl bg-white overflow-hidden shadow-sm divide-y divide-slate-100">
        <LibraryItem
      ...
      <div className="flex justify-center mt-10">
        <button className="flex items-center gap-2 border border-slate-200 px-6 py-2.5 rounded-xl text-sm font-black text-primary hover:bg-slate-50 transition-all duration-200 active:scale-95">
          Show More
          <ChevronDown size={18} />
        </button>
      </div>
